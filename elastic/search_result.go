...
// getProtocol tries to obtain a protocol from an elastic document, returning its string
...
func (h *Hit) DecodeIP(cfg *SearchConfig) (*client.IPEntry, error) {
	...
	e.Protocol = getProtocol(h, fn.Protocol)
