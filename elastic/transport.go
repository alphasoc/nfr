...
func (t *fastTransport) copyRequest(dst *fasthttp.Request, src *http.Request) *fasthttp.Request {
...
func (t *fastTransport) copyResponse(dst *http.Response, src *fasthttp.Response) *http.Response {
