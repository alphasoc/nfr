...
1483228800.000000	1	10.0.0.1	21	10.0.0.2	22	udp	ssh	-	-	-	S0	-	-	0	D	1	10	0	0	(empty)
1483228800.000000	2	10.0.0.1	21	10.0.0.2	22	tcp	ssh	-	-	20	S1	-	-	0	D	1	0	0	0	(empty)`
	)
